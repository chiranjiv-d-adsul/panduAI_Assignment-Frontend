...
const HelpChatBot = () => {
  return (
    <div
      className="p-4 font-sans font-normal text-white text-base bg-gray-100 rounded-lg shadow-md w-[22rem] overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="bg-gray-100 rounded-lg shadow-md py-3 mt-4">
        <div className="p-3 pb-8 bg-white rounded-lg shadow-inner">
          <input
            type="text"
            className="border-gray-300 rounded-lg focus:outline-none p-2 w-full"
        ...
        <div className="flex justify-between ml-0.5">
          <div className="flex justify-start">
            ...
            <button className="flex items-center justify-between px-2 bg-[#CBEFFF] text-white rounded-3xl ml-1">
              <PlusIcon className="h-4 w-4 text-[#0AB0FF]" />
...
//               The smartest and fastest AI yet?
//             </h3>
//             <p className="text-[#626B6F]">Invite friends to try Claude 3.5 Sonnet for free!</p>
//           </div>
//           <button className="absolute right-0.5 top-0.5 text-black hover:text-gray-600 text-md bg-white rounded-full w-6">
//             &times;
//           </button>
...
//       <div className=" bg-gray-100 rounded-lg shadow-md py-3">
//         <div className=" p-3 pb-8 bg-white rounded-lg shadow-inner ">
//           <input
//             type="text"
//             className="  border-gray-300 rounded-lg focus:outline-none"
//             placeholder="Type a message..."
//           />
//         </div>
//         <div className="flex justify-between ml-0.5">
